...
# HAPI Development Restart Script
# Stops server/runner and restarts both (no rebuild)
#
# Usage: ./dev-restart.sh [project_dir]
#   project_dir: Optional. Directory to run server from (default: /mnt/k/BENCH/PROJECTS/BoundMore)
#
# Run with sudo if needed: sudo ./dev-restart.sh
...
echo ""
log_info "=========================================="
log_info "HAPI Development Restart Script (no rebuild)"
